/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: e7720aaccf278516677ecd9435d7550d)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		LOG_PRETTY: "true";
		LOG_LEVEL: "warn";
		RATE_LIMIT_LOGIN_IP_MAX_ATTEMPTS: 5;
		RATE_LIMIT_LOGIN_USER_MAX_ATTEMPTS: 3;
		RATE_LIMIT_LOGIN_WINDOW_MINUTES: 10;
		CORS_ALLOWED_ORIGINS_PROD: "https://18bbm-forcemap-web.pages.dev";
		CORS_ALLOW_NO_ORIGIN_PROD: "false";
		CORS_ALLOW_CREDENTIALS_PROD: "false";
		CORS_ALLOWED_METHODS_PROD: "GET,POST,PUT,DELETE,PATCH";
		CORS_ALLOWED_HEADERS_PROD: "Content-Type,Authorization,X-Requested-With,Accept";
		CORS_EXPOSED_HEADERS_PROD: "";
		CORS_MAX_AGE_PROD: "86400";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOG_PRETTY" | "LOG_LEVEL" | "RATE_LIMIT_LOGIN_IP_MAX_ATTEMPTS" | "RATE_LIMIT_LOGIN_USER_MAX_ATTEMPTS" | "RATE_LIMIT_LOGIN_WINDOW_MINUTES" | "CORS_ALLOWED_ORIGINS_PROD" | "CORS_ALLOW_NO_ORIGIN_PROD" | "CORS_ALLOW_CREDENTIALS_PROD" | "CORS_ALLOWED_METHODS_PROD" | "CORS_ALLOWED_HEADERS_PROD" | "CORS_EXPOSED_HEADERS_PROD" | "CORS_MAX_AGE_PROD" | "JWT_ACCESS_EXPIRY" | "JWT_REFRESH_EXPIRY" | "BUN_ENV" | "JWT_ACCESS_SECRET" | "JWT_REFRESH_SECRET" | "API_SECRET">> {}
}
